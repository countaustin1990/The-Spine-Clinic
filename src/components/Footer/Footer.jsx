...
const Footer = () => {
 ...
 <li><Link href="./home" className="hover:text-blue-600">Home</Link></li>
              ...
              <li><Link href="./services" className="hover:text-blue-600">Our Services</a></li>
              <li><Link href="./contact" className="hover:text-blue-600">Contact</Link></li>
              <li><Link href="./appointments" className="hover:text-blue-600">Book an Appointment</Link></li>
            </ul>
          </div>
